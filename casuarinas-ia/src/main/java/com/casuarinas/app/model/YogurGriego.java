...
/**
 * CLASE ENTIDAD YOGUR GRIEGO - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de yogur griego en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "yogur_griego"
 ...
 */
@Entity
@Table(name = "yogur_griego")
public class YogurGriego {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Yogur griego 550mL";
    private Double precio = 310.0;
    private Integer stock = 15;
    private String comentario = "1 unidad 550mL";
    private String categoria = "Lácteos";
