...
/**
 * CLASE ENTIDAD QUESO DAMBO - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de queso dambo en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "queso_dambo"
 ...
 */
@Entity
@Table(name = "queso_dambo")
public class QuesoDambo {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Queso Dambo 400g";
    private Double precio = 230.0;
    private Integer stock = 6;
    private String comentario = "Dambo";
