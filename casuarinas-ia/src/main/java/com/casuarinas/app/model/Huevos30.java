...
/**
 * CLASE ENTIDAD HUEVOS 30 - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de huevos tamaño 30 en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "huevos_30"
 ...
 */
@Entity
@Table(name = "huevos_30")
public class Huevos30 {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Huevos 30";
    private Double precio = 390.0;
    private Integer stock = 20;
    private String comentario = "Tamaño 30";
