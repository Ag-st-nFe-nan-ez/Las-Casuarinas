...
/**
 * CLASE ENTIDAD QUESO RICOTTA - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de queso ricotta en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "queso_ricotta"
 ...
 */
@Entity
@Table(name = "queso_ricotta")
public class QuesoRicotta {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Queso Ricotta 400g";
    private Double precio = 75.0;
    private Integer stock = 12;
    private String comentario = "Ricotta";
