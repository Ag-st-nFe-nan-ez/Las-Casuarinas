...
/**
 * CLASE ENTIDAD HUEVOS 15 - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de huevos tamaño 15 en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "huevos_15"
 ...
 */
@Entity
@Table(name = "huevos_15")
public class Huevos15 {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Huevos 15";
    private Double precio = 250.0;
    private Integer stock = 30;
    private String comentario = "Tamaño 15";
