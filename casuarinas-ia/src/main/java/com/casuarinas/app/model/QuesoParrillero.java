...
/**
 * CLASE ENTIDAD QUESO PARRILLERO - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de queso parrillero en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "queso_parrillero"
 ...
 */
@Entity
@Table(name = "queso_parrillero")
public class QuesoParrillero {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Queso Parrillero 400g";
    private Double precio = 280.0;
    private Integer stock = 7;
    private String comentario = "Parrillero";
    private String categoria = "Quesos";
    private String unidad = "400g";
    private Boolean activo = true;

    public QuesoParrillero() {}
