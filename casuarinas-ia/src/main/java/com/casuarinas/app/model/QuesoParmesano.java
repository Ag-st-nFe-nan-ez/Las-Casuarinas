...
/**
 * CLASE ENTIDAD QUESO PARMESANO - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de queso parmesano en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "queso_parmesano"
 ...
 */
@Entity
@Table(name = "queso_parmesano")
public class QuesoParmesano {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Queso Parmesano 400g";
    private Double precio = 310.0;
    private Integer stock = 8;
    private String comentario = "Parmesano";
    private String categoria = "Quesos";
    private String unidad = "400g";
    private Boolean activo = true;

    public QuesoParmesano() {}
