...
/**
 * CLASE ENTIDAD HUEVOS 12 - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de huevos tamaño 12 en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "huevos_12"
 ...
 */
@Entity
@Table(name = "huevos_12")
public class Huevos12 {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Huevos 12";
    private Double precio = 220.0;
    private Integer stock = 50;
    private String comentario = "Tamaño 12";
