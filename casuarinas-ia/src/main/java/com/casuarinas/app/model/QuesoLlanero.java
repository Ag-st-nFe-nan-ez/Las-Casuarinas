...
/**
 * CLASE ENTIDAD QUESO LLANERO - PROGRAMACIÓN ORIENTADA A OBJETOS
 * 
 * Esta clase representa un producto específico de queso llanero en el sistema.
 ...
 * 
 * RELACIÓN CON SQL:
 * - @Entity + @Table: Genera una tabla SQL llamada "queso_llanero"
 ...
 */
@Entity
@Table(name = "queso_llanero")
public class QuesoLlanero {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    private String nombre = "Queso Llanero 400g";
    private Double precio = 180.0;
    private Integer stock = 10;
    private String comentario = "Llanero";
